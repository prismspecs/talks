const SLIDES = {
  "slides": [
    ...
    {
      "kind": "image",
      "src": "media/video1-grayson_earle.jpg",
      "caption": "The device, loaded with custom sousveillance software, records the choreography of its own transit from inside the package."
    },
    {
      "kind": "image",
      "src": "media/watching1-grayson_earle.jpg",
      "caption": "Visitors at ZKU, Berlin Art Week 2024."
    },
    {
      "kind": "youtube",
      "id": "Bc0Mi6RA0-c",
    ...
    },
    {
      ...
      "caption": "The box in transit - 14 minutes of audio recorded inside the returned package as it moved through Amazon's returns process."
    },
    {
      "kind": "image",
